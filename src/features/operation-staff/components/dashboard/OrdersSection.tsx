...
const OrdersSection: React.FC<OrdersSectionProps> = ({
  ...
  const tabs: TabItem[] = isSearchResult
    ...
    : [
        ...
        { id: 'PROCESSING', label: 'Đang gia công', isActive: activeTab === 'PROCESSING' },
        { id: 'PRODUCED', label: 'Đã đóng gói', isActive: activeTab === 'PRODUCED' },
        { id: 'PACKAGING', label: 'Đang đóng gói', isActive: activeTab === 'PACKAGING' },
        {
          id: 'HANDED_TO_CARRIER',
          label: 'Đã bàn giao cho ĐVVC',
          isActive: activeTab === 'HANDED_TO_CARRIER',
        },
      ];
